<div>
    ...
    <form method="POST" wire:submit.prevent="save">
        ...
        <div class="px-4 py-8 sm:px-6 lg:px-8 border sm:rounded-lg bg-white">
            ...
            <div class="grid grid-cols-4 gap-8">
                ...
                <div class="col-span-4 md:col-span-3 space-y-4">
                    ...
                    <div>
                        <label for="lang" class="block text-xs font-medium text-slate-500">
                    ...
                    <div>
                        <label for="website_style" class="block text-xs font-medium text-slate-500">
        ...
        <div class="px-4 py-8 sm:px-6 lg:px-8 border sm:rounded-lg my-6 bg-white">
            ...
            <div>
                <label for="spotify" class="block text-xs font-medium text-slate-500 mb-1">Spotify</label>
                <input id="spotify" type="text" wire:model.defer="spotifypodcasts_url">
            </div>
            <div class="my-6">
                <label for="apodcasts" class="block text-xs font-medium text-slate-500 mb-1">Apple Podcasts</label>
                <input id="apodcasts" type="text" wire:model.defer="applepodcasts_url">
            </div>
            <div class="my-6">
                <label for="gpodcasts" class="block text-xs font-medium text-slate-500 mb-1">Google Podcasts</label>
        ...
        <div class="px-4 sm:px-0 my-6 flex items-center justify-end gap-8">
            <label class="inline-flex items-center text-sm font-medium text-slate-500" title="{{ __('By checking this option you are making this podcast publicly visible.') }}">
