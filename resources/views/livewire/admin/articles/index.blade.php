                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        @forelse ($articles as $article)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium flex gap-4 float-right">
                                    @if ($article->published == FALSE)
                                    <button wire:click="changeStatus({{$article->id}})" class="text-indigo-600 hover:text-indigo-900">
                                    ...
                                    @endif
                                    <button wire:click="edit({{$article->id}})" class="text-indigo-600 hover:text-indigo-900">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
