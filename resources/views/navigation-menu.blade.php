<nav x-data="{ open: false }" class="bg-slate-900 border-b border-slate-800 @guest shadow @endguest">
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden space-x-4 sm:-my-px sm:ml-10 sm:flex items-center uppercase text-sm">
                ...
                @auth
                <a href="{{ route('podcasts') }}" class="text-white text-xs font-semibold px-8 py-3 border border-slate-600 rounded-lg hover:bg-slate-800 hover:border-slate-500 transition">
                ...
                <a href="{{ route('register') }}" class="text-white text-xs font-semibold px-8 py-3 border border-slate-600 rounded-lg hover:bg-slate-800 hover:border-slate-500 transition">
                    {{ __('Sign up') }}
                </a>
                @endguest
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-slate-600 hover:text-slate-600 hover:bg-slate-100 focus:outline-none focus:bg-slate-100 focus:text-gray-600 transition duration-150 ease-in-out">
