            ...
            <div class="md:flex mb-6 items-center">
                ...
                <div class="w-full py-8 md:w-3/4 px-4 sm:px-12">
                    <div>
                        ...
                        <div class="mt-6 flex">
                            <a href="{{ route('genRss', ['podcast' => $podcast->url]) }}" target="_blank" title="{{ __('RSS Feed') }}" class="flex text-sm text-bluegray-600 items-center bg-bluegray-200 p-2 mx-2 rounded-lg hover:bg-bluegray-300 transition">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <a href="{{ route('podcast.display', ['podcast' => $podcast->url]) }}" target="_blank" title="{{ __('Website') }}" class="flex text-sm text-bluegray-600 items-center bg-bluegray-200 p-2 mx-2 rounded-lg hover:bg-bluegray-300 transition">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            @if ($podcast->episodes->count() > 0)
                                <a href="{{ route('podcast.reports', ['podcast' => $podcast->id]) }}" title="{{ __('Reports') }}" class="flex text-sm text-bluegray-600 items-center bg-bluegray-200 p-2 mx-2 rounded-lg hover:bg-bluegray-300 transition">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <a href="{{ route('podcasts.edit', ['podcast' => $podcast->id]) }}" title="{{ __('Edit podcast details') }}" class="flex text-sm text-bluegray-600 items-center bg-bluegray-200 p-2 mx-2 rounded-lg hover:bg-bluegray-300 transition">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
