...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    <div class="text-center mb-12 text-slate-900">
    ...
    <div class="w-full grid grid-cols-2 gap-8">
        ...
        <a href="{{ route('article.view', ['article' => $article['article_url']]) }}" class="col-span-2">
            <div class="bg-slate-100 text-slate-900 hover:bg-slate-200 transition duration-300 rounded-md p-8 flex items-center">
