...
@section('content')
    ...
    <div class="max-w-full mx-auto bg-center bg-no-repeat bg-cover" style="background-image: url({{$thumbnail}})">
        <div class="w-full bg-black bg-opacity-85 backdrop-filter backdrop-blur-lg sticky top-0">
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sticky">
                    ...
                    <div class="sm:flex items-center text-center sm:text-left gap-8">
                        ...
                        <div class="mt-8 sm:mt-0">
                            ...
                            <div class="flex items-center justify-center sm:justify-start gap-3 mt-6">
                                <a href="{{ route('genRss', ['podcast' => $url]) }}" target="_blank" class="font-semibold text-xs hover:underline">RSS</a>
                                @isset($spotifypodcasts_url)
                                    <a href="{{ $spotifypodcasts_url }}" target="_blank" class="font-semibold text-xs hover:underline">
                                ...
                                @isset($applepodcasts_url)
                                    <a href="{{ $applepodcasts_url }}" target="_blank" class="font-semibold text-xs hover:underline">
                                        <svg class="w-6 h-6 fill-current bg-purple-600 p-0.5 rounded-lg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                ...
                                @isset($googlepodcasts_url)
                                    <a href="{{ $googlepodcasts_url }}" target="_blank" class="font-semibold text-xs hover:underline">
